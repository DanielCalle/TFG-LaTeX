...
Tiene una curva de aprendizaje media y con su versión 1.5 demuestra una
 ...
 provista por Google de dispositivos soportados\cite{arcoresupporteddevices}.
...
\paragraph{Wikitude\cite{wikitude}:}
...
\paragraph{Vuforia\cite{vuforia}:}
...
\paragraph{ViroReact\cite{viroreact}:}
...
\paragraph{IMDB:}
Nos decidimos por usar la página web de \textbf{IMDB}\cite{imdb} para conseguir las valoraciones, resúmenes, nombre del director,
