...
Para que esta aplicación sea usable e interactiva necesitamos investigar que necesitamos para poder llevarla a cabo por lo que
en esta sección de la memoria procederemos a describir las tecnologías que hemos implementado
en nuestro trabajo, tales como la realidad aumentada, las distintas fuentes de información, 
técnicas de recomendación, junto a un análisis de la competencia. Consiguiendo así todo lo necesario para ponernos manos a la obra
...
el eje W que representa la rotación del dispositivo. En la figura 2.4 se puede observar como cambia el elemento virtual según como situemos nuestro
smartphone.
...
Utiliza ARCore o ARKit cuando los dispositivos lo soportan y en caso contrario utiliza tecnología de Wikitude
 ...
 de imágenes y el reconocimiento en la nube. Para entender como funciona este SDK tenemos que describir tres términos básicos fundamentales:
\begin{itemize}
...
También proporciona componentes de interfaz de usuario para manejar una variedad de casos de uso que casi todas las aplicaciónes móviles tiene que cubrir pero no están
