...
De todas estas sistemas de recomendación, se pueden dividir según sus formas de realizar recomendaciones:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6.5in, angle=0]{figures/chapter-2/recommendation_systems.png}
