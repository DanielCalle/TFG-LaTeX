...
\begin{itemize}  
    ...
    \item Desarrollar aplicación para dispositivos móviles que aplique las anteriores tecnologías en un proyecto real.
    \item Administrar y configurar servicios web que provisiones de información a la aplicación.
