...
\begin{figure}[H]
    \centering
    \includegraphics[width=3in]{figures/escudo.jpg}
...
guardar la película en nuestra lista de películas guardadas, para posteriormente acceder a su información, valorarla o crear un plan con ella. Todo esto lo podemos observar en la figura 3.5.
