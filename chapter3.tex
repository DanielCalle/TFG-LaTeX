...
\begin{flushleft}
El objetivo del prototipo es reconocer imágenes almacenadas en el dispositivo y mostrar texto y
 objetos virtuales. Además de probar tecnologías de desarrollo móvil web como en este caso \textbf{React Native}
 tanto en plataformas de \textbf{iOS} como en \textbf{Android}.
\end{flushleft}
\begin{flushleft}
Comenzamos con una interfaz sencilla con botones que nos llevará a la escena de RA.
...
Para la escena de realidad aumentada mostramos texto y al detectar el poster de Pantera Negra,
 reaciona mostrando la animación de dicho super heroe saltando del póster.
\end{flushleft}
 
\begin{flushleft}
Una de las ventajas que apreciamos fue facilidad del lenguaje en este caso \textbf{Javascript}
 utilizando el popular framework \textbf{ReactJS} y la buena documentación de \textbf{ViroMedia}
 hacia que el proceso de codificación fuera agradable.
\end{flushleft}
\begin{flushleft}
Uno de los problemas es que las dependencias de ViroMedia entran en conflicto con las de native base
 no habiendo forma de encontrar versiones compatibles utilizamos la ultima que a pesar de lanzar
 advertencias funcionaba el ejemplo realizado.
Otro problema es la compilación de la aplicación, viro media tiene una aplicación para probar la
...
\begin{flushleft}
La conlusión fue que \textbf{ViroMedia} y \textbf{React Native} son tecnologías muy prometedoras pero debido a los
